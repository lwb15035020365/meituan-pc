<template>
    <div class="m-nav">
        <ul class="nav">
            <li class="list my">
                <router-link :to="{name: 'index'}">我的美团</router-link>
                 <dl>
                    <dd>
            ...
            <li class="list">
                 <router-link :to="{name: 'index'}">手机APP</router-link>
            </li>
            <li class="list bd">
                 <router-link :to="{name: 'index'}">商家中心</router-link>
                 <dl>
                    <dd>
            ...
            <li class="list">
                 <router-link :to="{name: 'index'}">美团规则</router-link>
                   <dl>
                    <dd>
            ...
            <li class="list site">
                 <router-link :to="{name: 'index'}">网站导航</router-link>
